...
3. Start the queue board
   ...
   **You should see:** `Queue board running at http://localhost:3000`. Open <http://localhost:3000> in your browser — the board shows four empty columns: Inbox, Review, Quality Review, Done.
